     ...
     <Card styles="{'--theme-color:var(--theme4);--text-color:var(--text2);'}">
      <h2 class="notranslate" style="color:var(--accent1)">kalidoface</h2>
       <div>
         ...
         <ul>
           <li><a href='https://twitter.com/hootalex'>hootalex</a>: {cardText[6].list[$setLang][0]}</li>
           <li><a href='https://pixiv.github.io/three-vrm/docs/'>Pixiv</a>: {cardText[6].list[$setLang][1]}</li>
           <li><a href='https://glitch.com'>Glitch</a>: {cardText[6].list[$setLang][2]}</li>
           <li><a href='https://google.github.io/mediapipe/'>Google MediaPipe</a>: {cardText[6].list[$setLang][3]}</li>
           <li><a href='https://hub.vroid.com/'>Vroid Hub</a>: {cardText[6].list[$setLang][4]}</li>
         </ul>      
       </div>
       <div></div>
...
/*     text-shadow: 0px 0px 8px #00000020; */
  ...
  h4{
    font-size: clamp(18px, calc(3vh + 1vw), 28px);
    font-weight: 700;
    margin-bottom: 16px;
    margin-top: 0;
    letter-spacing: -.6px;
