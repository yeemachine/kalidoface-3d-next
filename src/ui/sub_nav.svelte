...
import Lights from './sub_nav.lights.svelte'
import Extra from './sub_nav.extra.svelte'
...
$:{
  ...
  case 'char':
      theme='var(--darkgrey)'
      customVars="--container-w-d:180px;--container-h-m:260px;"
      maxY = 260
    break;
  case 'call':
      theme='var(--darkgrey)'
  ...
  case 'sticker':
      theme='var(--darkgrey)'
      customVars="--container-w-d:180px;"
      maxY = 210
    break;
  case 'settings':
      theme='var(--darkgrey)'
  ...
  case 'lights':
      theme='var(--darkgrey)'
      customVars="--container-w-d:320px;--container-h-m:360px;"
      maxY = 360;
    break;
  case 'exp':
    customVars="--container-w-d:270px;--container-h-m:300px;"
    theme='var(--darkgrey)'
    maxY = 300
  break;
  default:
