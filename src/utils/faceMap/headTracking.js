...
export const headRotation = plane => {
  ...
  let midPoint = plane[0].lerp(plane[1],.5)
  ...
  return {
    //Live2D and 3D use different rotation axis order. 
    //Output below defaults to 3D rotation axis.
    ...
    width:width,
    height:height,
    position:midPoint.lerp(plane[2],.5),//center of face detection square
    normalized: {
